...
namespace WindowsFormsApp2
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            string token = "5994049019:AAEHPfd8xOmyWhRXKNF90HZUD4dVVH76Fuw";
            ...
            async Task HandleUpdateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
            {
                ...
                {
                    reply = " Ý bạn là việt học cùng lớp hả, cậu ấy rất tuyệt vời";
                }
                ...
                else if (messLow.StartsWith("toàn"))
                {
                    reply = " Bạn ấy thật giỏi bởi vì bạn ấy đã làm ra tôi ";
                }
                else if (messLow.StartsWith("nguyệt mun"))
                {
                    reply = " Bạn vẫn còn nhớ cô ấy sao , không sao đâu sau này bạn sẽ có được cô ấy mà ";
                }

                else if (new[] { "cô gái năm ấy", "cô gái tôi thương", "cô gái học cùng cấp 2" }.Any(keyword => messLow.Contains(keyword)))
                {
                    reply = "ý bạn có phải là nguyệt mun , bạn hay nhắc đến cô ấy với tôi";
                }
                else if (messLow.StartsWith("sinh nhật của tôi"))
                {
                    reply = " 18/12/2001, tôi nhớ mà chủ nhân của tôi ơi ";
                }
                else if (messLow.StartsWith("định"))
                {
                    reply = " bạn ấy học rất giỏi ";
                }
                else
                {
        ...
        private void InitializeComponent()
        {
            ...
            // txtLog
            // 
            this.txtLog.Location = new System.Drawing.Point(329, 83);
            this.txtLog.Multiline = true;
            this.txtLog.Name = "txtLog";
            this.txtLog.Size = new System.Drawing.Size(373, 76);
            this.txtLog.TabIndex = 0;
            this.txtLog.TextChanged += new System.EventHandler(this.textBox1_TextChanged);
            // 
            // Form1
            // 
            this.ClientSize = new System.Drawing.Size(1142, 393);
